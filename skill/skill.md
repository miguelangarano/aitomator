...
Each run is preserved at `executions/<workflowId>/<executionId>/execution.log`. It includes daemon and runner lifecycle events, step events, `ctx.log.*`, and node `console.*` output.
